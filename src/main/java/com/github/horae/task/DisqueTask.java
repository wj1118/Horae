 ...
 */
public class DisqueTask extends TaskTemplate {

    private static final Log logger = LogFactory.getLog(DisqueTask.class);

    public DisqueTask(CountDownLatch signal, String queueName,
